"""
# Script for fine-tuning marine snow segmentation (based on SUIM-Net)
...
if base_ == "RSB":
    im_res_ = (320, 240, 3)
    ckpt_name_base = "custom_suimnet_rsb.hdf5"
    ckpt_name_custom = "custom_ft_suimnet_rsb.hdf5"
else:
    im_res_ = (320, 256, 3)
    ckpt_name_base = "custom_suimnet_vgg.hdf5"
    ckpt_name_custom = "custom_ft_suimnet_vgg.hdf5"
...
custom_model.load_weights(base_model_path)
...
early_stop_callback = callbacks.EarlyStopping(monitor="loss", patience=1)
