...
from keras.models import Model  # for encoder and decoder
from keras.layers import Input  # for encoder and decoder
from keras.layers import Convolution2D as Conv2D  # for encoder and decoder
...
class SUIM_Net:
    ...
    def get_model_VGG16(self, n_classes):
        ...
        ## return output layer
        out = Conv2D(
            n_classes, (3, 3), padding="same", activation="sigmoid", name="output"
        )(dec4)
